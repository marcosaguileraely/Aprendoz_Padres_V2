...
public class Aprendoz_desarrolloConstants {
    ...
    public final static String _detallesAlimentosQueryName = "_detallesAlimentos";
    public final static String _existeFichaMedicaByUserQueryName = "_existeFichaMedicaByUser";
    public final static String _hqlAlergiasByUserQueryName = "_hqlAlergiasByUser";
    ...
    public final static String getGrupoFamiliarbyUserQueryName = "getGrupoFamiliarbyUser";
    public final static String getIdPersonabyUserQueryName = "getIdPersonabyUser";
    ...
    public final static String listadoEstudiantesGrupoFamiliarQueryName = "listadoEstudiantesGrupoFamiliar";
